...
public class EnrollmentServiceImpl implements EnrollmentService {
    ...
    private final OverloadRequestRepository overloadRequestRepository = new OverloadRequestRepositoryImpl();
    ...
    public boolean enrollStudent(int studentId, int sectionId) {
        ...
        Integer approvedUnits = overloadRequestRepository.getApprovedUnits(studentId);
        ...
        if (enrollmentRepository.isAlreadyEnrolled(studentId, sectionId)) {
    ...
    public boolean updateRegistrationStatus(int enrollmentId, String status) {
        return enrollmentId > 0 && status != null
                && status.trim().toUpperCase().matches("PENDING|ENROLLED|DROPPED")
    ...
    public boolean submitGrade(int enrollmentId, String finalGrade, double gpaPoints) {
        ...
        return enrollmentRepository.updateGrade(enrollmentId, finalGrade, gpaPoints);
    }
